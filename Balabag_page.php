...
<body>
    <div class="container my-5">
        <h2>List of Farmers in BALABAG</h2>
        <br>
        <a href="Balabag_report.php" class="btn"> Create Report </a>
        ...
        <table class="table">
            ...
            <tbody>
                <?php
                    ...
                    $sql = "SELECT * FROM farmer_acc WHERE barangay = 'Balabag'";
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a class='btn btn-primary btn-sm' href='/AgriConnectN/Balabag_update.php?ID={$row['ID']}'>Update</a>
                            </td>
                        </tr>
                        ";
                    }
