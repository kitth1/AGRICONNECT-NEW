...
<body>
    <div class="container my-5">
        ...
        <a href="Balabag_print_report.php" class="btn"> Print Report </a>
        ...
        <table class="table" border="1">
            ...
            <tbody>
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        <td>$row[date]</td>
                        <td>
                        <a class='btn btn-primary btn-sm' href='/AgriConnectN/Balabag_delete_report.php?ID=$row[ID]'> delete </a>
                        </td>
                    </tr>
                        ";
                    }
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ( empty($farm_name) || empty($week_report) || empty($date))  {
        ...
        $stmt = $conn->prepare("INSERT INTO balabag_report (farm_name, week_report, date) VALUES (?, ?, ?)");
    ...
    <div class="container my-5">
        ...
        <div class="row mb-3">
            ...
            <div class="form-actions">
                ...
                <button type="button" class="btn btn-cancel" onclick="location.href='/AgriConnectN/Balabag_page.php'">Cancel</button>
            </div>
        </form>
    </div>
