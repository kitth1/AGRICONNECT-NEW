...
<body>
    <div class="container my-5">
        <h2>List of Farmers in BAGUMBAYAN</h2>
        <br>
        <a href="Bagumbayan_report.php" class="btn"> Create Report </a>
        ...
        <table class="table">
            ...
            <tbody>
                <?php
                    ...
                    $sql = "SELECT * FROM farmer_acc WHERE barangay = 'Bagumbayan'";
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a class='btn btn-primary btn-sm' href='/AgriConnectN/Bagumbayan_update.php?ID={$row['ID']}'>Update</a>
                            </td>
                        </tr>
                        ";
                    }
